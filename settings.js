...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&u2NnyrkG' : process.env.SESSION_ID, // put your session id || ඔයාගෙ සෙසන් එක දාන්න...😌❤
...
SUDO: process.env.SUDO === undefined ? '+639318803096' :process.env.SUDO,
